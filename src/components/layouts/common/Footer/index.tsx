...
const Footer = () => {
    return (
        <Box as="footer" bg={'blackAlpha.50'} borderTop="1px solid" borderColor="blackAlpha.300" py="2.5rem" fontSize="0.875rem">
            <Box maxW="72rem" marginX="auto" pb="2rem" mb="1.5rem" borderBottom="1px solid" borderColor="blackAlpha.300">
                <Flex flexWrap="wrap" alignItems="start" justify="space-between">
                    <Box w={{ base: '100%', sm: '50%', md: 'max-content' }} mb={{ base: '1.5rem', lg: '0' }}>
                        <Heading as="h5" color="blackAlpha.700" mb="0.5rem" fontSize="0.875rem" fontWeight="600">
                            Company Name
                        </Heading>
            ...
            <Flex maxW="72rem" mx="auto" alignItems="center">
                <svg
                    fill="#008F94"
                ...
                <Text color="blackAlpha.600" fontSize="0.875rem" pl="0.5rem">
