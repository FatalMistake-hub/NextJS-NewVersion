...
const Footer = () => {
    return (
        <Box as="footer" bg="gray.100" borderTop="1px solid" borderColor="gray.300" py="2.5rem" fontSize="0.875rem">
            <Box maxW="72rem" marginX="auto" pb="2rem" mb="1.5rem" borderBottom="1px solid" borderColor="gray.300">
